...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dhun.Core.Models.Album", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dhun.Core.Models.AlbumArtist", b =>
                {
            ...
            modelBuilder.Entity("Dhun.Core.Models.Artist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dhun.Core.Models.Folder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dhun.Core.Models.Genre", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dhun.Core.Models.ListenHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Dhun.Core.Models.Playlist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dhun.Core.Models.PlaylistSong", b =>
                {
            ...
            modelBuilder.Entity("Dhun.Core.Models.SmartPlaylist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dhun.Core.Models.SmartPlaylistRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dhun.Core.Models.Song", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dhun.Core.Models.SongArtist", b =>
                {
                    b.Property<Guid>("SongId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("GenreSong", b =>
                {
                    b.HasOne("Dhun.Core.Models.Genre", null)
                        .WithMany()
                        .HasForeignKey("GenresId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dhun.Core.Models.Song", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Dhun.Core.Models.AlbumArtist", b =>
                {
                    b.HasOne("Dhun.Core.Models.Album", "Album")
                        .WithMany("AlbumArtists")
                        .HasForeignKey("AlbumId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dhun.Core.Models.Artist", "Artist")
                        .WithMany("AlbumArtists")
            ...
            modelBuilder.Entity("Dhun.Core.Models.Folder", b =>
                {
                    b.HasOne("Dhun.Core.Models.Folder", "ParentFolder")
                        .WithMany("SubFolders")
            ...
            modelBuilder.Entity("Dhun.Core.Models.ListenHistory", b =>
                {
                    b.HasOne("Dhun.Core.Models.Song", "Song")
            ...
            modelBuilder.Entity("Dhun.Core.Models.PlaylistSong", b =>
                {
                    b.HasOne("Dhun.Core.Models.Playlist", "Playlist")
            ...
            modelBuilder.Entity("Dhun.Core.Models.SmartPlaylistRule", b =>
                {
                    b.HasOne("Dhun.Core.Models.SmartPlaylist", "SmartPlaylist")
                        .WithMany("Rules")
            ...
            modelBuilder.Entity("Dhun.Core.Models.Song", b =>
                {
                    ...
                    b.HasOne("Dhun.Core.Models.Folder", "Folder")
                        .WithMany("Songs")
