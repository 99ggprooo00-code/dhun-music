...
namespace Dhun.Core.Resources;

/// <summary>
///     Provides thread-safe access to the localized strings for the Dhun.Core library.
/// </summary>
public static class Strings
{
    private static readonly ResourceManager _resourceManager =
        new("Dhun.Core.Resources.Strings", typeof(Strings).Assembly);
