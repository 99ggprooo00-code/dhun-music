...
namespace Dhun.WinUI.Converters;
...
public class ElementThemeToFriendlyStringConverter : IValueConverter
{
    ...
    {
        { ElementTheme.Light, Dhun.WinUI.Resources.Strings.Theme_Light },
        { ElementTheme.Dark, Dhun.WinUI.Resources.Strings.Theme_Dark },
        { ElementTheme.Default, Dhun.WinUI.Resources.Strings.Theme_Default }
    };
...
public class BackdropMaterialToStringConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, string language)
    {
        if (value is BackdropMaterial material)
            ...
            {
                BackdropMaterial.Mica => Dhun.WinUI.Resources.Strings.Backdrop_Mica,
                BackdropMaterial.MicaAlt => Dhun.WinUI.Resources.Strings.Backdrop_MicaAlt,
                BackdropMaterial.Acrylic => Dhun.WinUI.Resources.Strings.Backdrop_Acrylic,
                _ => material.ToString()
            };
        return string.Empty;
    }
...
public class PlayerBackgroundMaterialToStringConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, string language)
    {
        if (value is PlayerBackgroundMaterial material)
            return material switch
            {
                PlayerBackgroundMaterial.Acrylic => Dhun.WinUI.Resources.Strings.PlayerBackgroundMaterial_Acrylic,
                PlayerBackgroundMaterial.Solid => Dhun.WinUI.Resources.Strings.PlayerBackgroundMaterial_Solid,
                _ => material.ToString()
            };
        return string.Empty;
    }
