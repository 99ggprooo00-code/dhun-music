...
namespace Dhun.WinUI.Resources;

/// <summary>
///     Provides thread-safe access to the localized strings for the Dhun.WinUI project.
/// </summary>
public static class Strings
{
    public static readonly ResourceManager ResourceManager =
        new("Dhun.WinUI.Resources.Strings", typeof(Strings).Assembly);
