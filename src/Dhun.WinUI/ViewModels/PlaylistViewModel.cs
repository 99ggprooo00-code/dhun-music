    ...
    public void UpdateSongCount(int newSongCount)
    {
        ...
        if (IsSmart)
        {
            SongCountText = newSongCount == 1
                ? ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Playlist_Smart_Count_Singular, newSongCount)
                : ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Playlist_Smart_Count_Plural, newSongCount);
        }
        else
        {
            SongCountText = newSongCount == 1
                ? ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Playlist_Count_Singular, newSongCount)
                : ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Playlist_Count_Plural, newSongCount);
        }
    }
}

/// <summary>
///     ViewModel for madhunng the collection of playlists.
/// </summary>
public partial class PlaylistViewModel : SearchableViewModelBase, IDisposable
{
    ...
    private async Task PlayPlaylistAsync(Tuple<Guid, bool> args)
    {
        ...
        StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_Starting;
        try
        {
            if (isSmart)
            {
                ...
                if (songIds.Count == 0)
                {
                    StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_SmartEmpty;
        ...
        {
            StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_ErrorPlayback;
    ...
    private async Task PlayRandomPlaylistAsync()
    {
        ...
        StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_PickingRandom;
        ...
        try
        {
            ...
            if (totalCount == 0)
            {
                StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_NoPlaylists;
                return;
            }
            ...
            else
            {
                ...
                if (id.HasValue)
                {
                    ...
                    {
                        StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_SmartSelectedEmpty;
                    }
                }
            }
        }
        ...
        {
            StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_ErrorRandom;
    ...
    private async Task LoadPlaylistsAsync()
    {
        try
        {
            StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_Loading;
        ...
        {
            StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_ErrorLoadingPlaylists;
    ...
    private async Task CreatePlaylistAsync(Tuple<string, string?> args)
    {
        ...
        StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_Creating;
        ...
        try
        {
            ...
            {
                StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_CreateFailed;
            }
        }
        catch (Exception ex)
        {
            StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_CreateError;
    ...
    private async Task UpdatePlaylistCoverAsync(Tuple<Guid, string, bool> args)
    {
        ...
        Interlocked.Increment(ref _isMutating);
        StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_UpdatingCover;
        ...
        try
        {
            ...
            {
                StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_UpdateCoverFailed;
            }
        }
        catch (Exception ex)
        {
            StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_UpdateCoverError;
    ...
    private async Task RemovePlaylistCoverAsync(Tuple<Guid, bool> args)
    {
        ...
        IsUpdatingCover = true;
        Interlocked.Increment(ref _isMutating);
        StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_RemovingCover;
        ...
        try
        {
            ...
            {
                StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_RemoveCoverFailed;
            }
        }
        catch (Exception ex)
        {
            StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_RemoveCoverError;
    ...
    private async Task RenamePlaylistAsync(Tuple<Guid, string, bool> args)
    {
        ...
        Interlocked.Increment(ref _isMutating);
        StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_Renaming;
        ...
        try
        {
            ...
            {
                StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_RenameFailed;
            }
        }
        catch (Exception ex)
        {
            StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_RenameError;
    ...
    private async Task DeletePlaylistAsync(Tuple<Guid, bool> args)
    {
        ...
        Interlocked.Increment(ref _isMutating);
        StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_Deleting;
        ...
        try
        {
            ...
            {
                StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_DeleteFailed;
            }
        }
        catch (Exception ex)
        {
            StatusMessage = Dhun.WinUI.Resources.Strings.Playlist_Status_DeleteError;
