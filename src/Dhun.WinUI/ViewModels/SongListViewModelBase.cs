...
public abstract partial class SongListViewModelBase : PagedListViewModelBase<Song>
{
    ...
    [ObservableProperty] public partial string PageTitle { get; set; } = Dhun.WinUI.Resources.Strings.SongList_PageTitle_Default;
    ...
    protected override string FormatTotalItemsText(int count) =>
        count == 1
            ? ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.SongList_TotalItems_Format_Singular, count)
            : ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.SongList_TotalItems_Format_Plural, count);
    ...
    protected void UpdateSelectionStatus()
    {
        ...
        SelectedItemsCountText = count > 0
            ? ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.SongList_SelectedCount_Format, count)
            : string.Empty;
