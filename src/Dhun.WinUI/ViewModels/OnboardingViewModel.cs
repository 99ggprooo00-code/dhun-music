...
{
    private static string InitialWelcomeMessage => Dhun.WinUI.Resources.Strings.Onboarding_Welcome;
    ...
    private async Task AddFolder()
    {
        ...
        IsAddingFolder = true;
        StatusMessage = Dhun.WinUI.Resources.Strings.Onboarding_WaitingForSelection;
        ...
        try
        {
            ...
            if (folderPath != null)
            {
                ...
                IsParsing = true;
                StatusMessage = Dhun.WinUI.Resources.Strings.Onboarding_BuildingLibrary;
        ...
        {
            StatusMessage = Dhun.WinUI.Resources.Strings.Onboarding_Error;
