...
public partial class AlbumViewViewModel : SongListViewModelBase
{
    ...
    {
        AlbumTitle = Dhun.WinUI.Resources.Strings.AlbumView_DefaultAlbumTitle;
        ArtistName = Dhun.WinUI.Resources.Strings.AlbumView_DefaultArtistName;
    ...
    private void HandleAlbumNotFound(Guid albumId)
    {
        ...
        AlbumTitle = Dhun.WinUI.Resources.Strings.AlbumView_AlbumNotFound;
        PageTitle = Dhun.WinUI.Resources.Strings.Generic_NoItems;
        ArtistName = string.Empty;
        AlbumArtists = new List<AlbumArtist>();
        CoverArtUri = null;
        Songs.Clear();
        TotalItemsText = ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Songs_Count_Plural, 0);
    }

    private void HandleLoadError(Guid albumId, Exception ex)
    {
        _logger.LogError(ex, "Failed to load album with ID {AlbumId}", albumId);
        AlbumTitle = Dhun.WinUI.Resources.Strings.AlbumView_Error;
    ...
    private void RefreshAlbumDetailsText()
    {
        ...
        var songCountText = _totalSongCount == 1
            ? ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.AlbumView_SongCount_Singular, _totalSongCount)
            : ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.AlbumView_SongCount_Plural, _totalSongCount);
...
public class DiscHeader
{
    ...
    public string Title => string.Format(Dhun.WinUI.Resources.Strings.AlbumView_DiscHeader, DiscNumber);
}
