...
/// <summary>
///     A specialized song list view model for displaying and madhunng songs within a single playlist.
/// </summary>
public partial class PlaylistSongListViewModel : SongListViewModelBase
{
    ...
    public async Task InitializeAsync(string title, Guid? playlistId, string? coverImageUri = null)
    {
        ...
        catch (Exception ex)
        {
            ...
            TotalItemsText = Dhun.WinUI.Resources.Strings.Playlist_ErrorLoading;
            Songs.Clear();
        }
    }
