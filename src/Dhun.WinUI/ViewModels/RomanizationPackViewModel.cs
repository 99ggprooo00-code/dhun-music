...
public partial class RomanizationPackViewModel : ObservableObject
{
    ...
    public string LicenseText => string.IsNullOrWhiteSpace(License)
        ? string.Empty
        : string.Format(Dhun.WinUI.Resources.Strings.SettingsPage_RomanizationPack_LicenseFormat, License);
    ...
    public string StatusText
    {
        get
        {
            if (IsUpdateAvailable) return Dhun.WinUI.Resources.Strings.SettingsPage_RomanizationPack_UpdateAvailable;
            if (IsInstalled) return string.Format(Dhun.WinUI.Resources.Strings.SettingsPage_RomanizationPack_InstalledFormat, InstalledVersion);
            return Dhun.WinUI.Resources.Strings.SettingsPage_RomanizationPack_NotInstalled;
        }
    }
