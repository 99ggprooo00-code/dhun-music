...
public partial class ArtistViewModel : PagedListViewModelBase<Artist>
{
    ...
    protected override string FormatTotalItemsText(int count) =>
        count == 1
            ? ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Artists_Count_Singular, count)
            : ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Artists_Count_Plural, count);
