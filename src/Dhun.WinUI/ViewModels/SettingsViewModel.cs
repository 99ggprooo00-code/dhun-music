...
public partial class SettingsViewModel : ObservableObject, IDisposable
{
    ...
    async partial void OnSelectedLanguageChanged(Dhun.WinUI.Models.LanguageModel value)
    {
    ...
    public ObservableCollection<Dhun.WinUI.Models.LanguageModel> AvailableLanguages { get; } = new();

    [ObservableProperty] public partial Dhun.WinUI.Models.LanguageModel SelectedLanguage { get; set; }
    ...
    public async Task LoadSettingsAsync()
    {
        ...
        try
        {
            ...
            AvailableLanguages.Add(new LanguageModel(string.Empty, Dhun.WinUI.Resources.Strings.Language_Auto));
    ...
    private async Task LoadRomanizationPacksAsync(bool forceRefresh)
    {
        ...
        try
        {
            ...
            _dispatcherService.TryEnqueue(() =>
            {
                ...
                RomanizationPacksStatus = RomanizationPacks.Count == 0
                    ? Dhun.WinUI.Resources.Strings.SettingsPage_RomanizationPacks_None
                    : null;
            });
        }
        ...
        catch (Exception ex)
        {
            ...
            {
                if (token.IsCancellationRequested || _isDisposed) return;
                RomanizationPacksStatus = string.Format(Dhun.WinUI.Resources.Strings.SettingsPage_RomanizationPacks_LoadFailedFormat, ex.Message);
            });
        }
        finally
        {
    ...
    private async Task InstallRomanizationPackAsync(RomanizationPackViewModel? pack)
    {
        ...
        try
        {
            ...
            if (!result.Succeeded)
            {
                RomanizationPacksStatus = result.ErrorMessage ?? Dhun.WinUI.Resources.Strings.SettingsPage_RomanizationPacks_InstallFailed;
                return;
            }
    ...
    private async Task RemoveRomanizationPackAsync(RomanizationPackViewModel? pack)
    {
        ...
        try
        {
            ...
            if (!result.Succeeded)
            {
                RomanizationPacksStatus = result.ErrorMessage ?? Dhun.WinUI.Resources.Strings.SettingsPage_RomanizationPacks_RemoveFailed;
                return;
            }
    ...
    private string ResolveCultureWithResources(string cultureCode, CultureInfo[] allSpecificCultures)
    {
        try
        {
            ...
            var resourceManager = Dhun.WinUI.Resources.Strings.ResourceManager;
    ...
    private async Task ResetApplicationDataAsync()
    {
        var confirmed = await _uiService.ShowConfirmationDialogAsync(
            Dhun.WinUI.Resources.Strings.Settings_Reset_Title,
            Dhun.WinUI.Resources.Strings.Settings_Reset_Message,
            Dhun.WinUI.Resources.Strings.Settings_Reset_Button,
            null);
        ...
        catch (Exception ex)
        {
            ...
            await _uiService.ShowMessageDialogAsync(
                Dhun.WinUI.Resources.Strings.Settings_ResetError_Title,
                string.Format(Dhun.WinUI.Resources.Strings.Settings_ResetError_Message, ex.Message));
        }
    }
    ...
    private async Task LastFmInitialAuthAsync()
    {
        ...
        {
            await _uiService.ShowMessageDialogAsync(Dhun.WinUI.Resources.Strings.Settings_LastFm_AuthError_Title, Dhun.WinUI.Resources.Strings.Settings_LastFm_AuthError_Message);
    ...
    private async Task LastFmFinalizeAuthAsync()
    {
        ...
        {
            await _uiService.ShowMessageDialogAsync(Dhun.WinUI.Resources.Strings.Settings_LastFm_FinalizeError_Title,
                Dhun.WinUI.Resources.Strings.Settings_LastFm_FinalizeError_Message);
        }
    ...
    {
        var confirmed = await _uiService.ShowConfirmationDialogAsync(
            Dhun.WinUI.Resources.Strings.Settings_LastFm_Disconnect_Title,
            Dhun.WinUI.Resources.Strings.Settings_LastFm_Disconnect_Message,
            Dhun.WinUI.Resources.Strings.Settings_LastFm_Disconnect_Button,
            null);
    ...
    private async Task ResetEqualizerAsync()
    {
        ...
        SelectedEqualizerPreset = AvailableEqualizerPresets.FirstOrDefault(p => p.Name == Dhun.Core.Resources.Strings.EqPreset_None);
    }
    ...
    private async Task ExportAllPlaylistsAsync()
    {
        ...
        if (result.Success)
        {
            await _uiService.ShowMessageDialogAsync(Dhun.WinUI.Resources.Strings.Settings_Export_Success_Title,
                ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Settings_Export_Success_Message, result.PlaylistsExported, result.TotalSongs, folderPath));
        }
        else
        {
            await _uiService.ShowMessageDialogAsync(Dhun.WinUI.Resources.Strings.Settings_Export_Failed_Title, result.ErrorMessage ?? Dhun.WinUI.Resources.Strings.Settings_Export_Failed_Message);
        }
    }
    ...
    private async Task ImportMultiplePlaylistsAsync()
    {
        ...
        if (result.Success)
        {
            var message = ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Settings_Import_Success_Message, result.PlaylistsImported, result.TotalMatchedSongs);
            if (result.TotalUnmatchedSongs > 0)
            {
                message += ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Settings_Import_Unmatched_Message, result.TotalUnmatchedSongs);
            }
            if (result.FailedFiles.Count > 0)
            {
                message += ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Settings_Import_FailedFiles_Message, result.FailedFiles.Count);
            }
            await _uiService.ShowMessageDialogAsync(Dhun.WinUI.Resources.Strings.Settings_Import_Success_Title, message);
        }
        else
        {
            await _uiService.ShowMessageDialogAsync(Dhun.WinUI.Resources.Strings.Settings_Import_FailedTotal_Title, Dhun.WinUI.Resources.Strings.Settings_Import_FailedTotal_Message);
        }
    }
    ...
    private async Task RescanMetadataAsync()
    {
        ...
        var confirmed = await _uiService.ShowConfirmationDialogAsync(
            Dhun.WinUI.Resources.Strings.Settings_Dialog_Rescan_Title,
            Dhun.WinUI.Resources.Strings.Settings_Dialog_Rescan_Content,
            Dhun.WinUI.Resources.Strings.Settings_Dialog_Rescan_PrimaryButton,
            null);

        if (!confirmed) return;

        _playerViewModel.IsGlobalOperationInProgress = true;
        _playerViewModel.GlobalOperationStatusMessage = Dhun.WinUI.Resources.Strings.Settings_Status_Rescan_Preparing;
        ...
        try
        {
            ...
            await _uiService.ShowMessageDialogAsync(Dhun.WinUI.Resources.Strings.Settings_Dialog_RescanComplete_Title, Dhun.WinUI.Resources.Strings.Settings_Dialog_RescanComplete_Content);
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Metadata rescan failed.");
            await _uiService.ShowMessageDialogAsync(Dhun.WinUI.Resources.Strings.Settings_Dialog_RescanFailed_Title, Dhun.WinUI.Resources.Strings.Settings_Dialog_RescanFailed_Content);
        }
        finally
        {
            ...
            if (value)
            {
                ...
                if (!isFFmpegInstalled)
                {
                    ...
                    var ffmpegDetected = await _uiService.ShowFFmpegSetupDialogAsync(
                        Dhun.WinUI.Resources.Strings.Settings_Dialog_FFmpegNotFound_Title,
                ...
                var confirmed = await _uiService.ShowConfirmationDialogAsync(
                    title: Dhun.WinUI.Resources.Strings.Settings_Dialog_VolumeNorm_Title,
                    content: Dhun.WinUI.Resources.Strings.Settings_Dialog_VolumeNorm_Content,
                    primaryButtonText: Dhun.WinUI.Resources.Strings.Settings_Dialog_VolumeNorm_PrimaryButton,
                    closeButtonText: Dhun.WinUI.Resources.Strings.Generic_Cancel);
    ...
    private async Task ScanLibraryForReplayGainAsync()
    {
        ...
        _playerViewModel.IsGlobalOperationInProgress = true;
        _playerViewModel.GlobalOperationStatusMessage = Dhun.WinUI.Resources.Strings.Settings_Status_VolumeNorm_Preparing;
        _playerViewModel.IsGlobalOperationIndeterminate = true;
        ...
        {
            _playerViewModel.GlobalOperationStatusMessage = Dhun.WinUI.Resources.Strings.Settings_Status_VolumeNorm_Cancelled;
        }
        catch (Exception ex)
        {
            _playerViewModel.GlobalOperationStatusMessage = string.Format(Dhun.WinUI.Resources.Strings.Settings_Status_VolumeNorm_Error_Format, ex.Message);
        ...
        try
        {
            ...
            if (result.IsValid)
            {
                ...
                ListenBrainzConnectionStatus = string.Format(
                    Dhun.WinUI.Resources.Strings.SettingsPage_ListenBrainz_Connected,
                    result.Username);
            }
            else
            {
                ...
                ListenBrainzConnectionStatus = string.Format(
                    Dhun.WinUI.Resources.Strings.SettingsPage_ListenBrainz_ConnectionFailed,
                    result.Error);
            }
        }
        catch (Exception ex)
    ...
    {
        var confirmed = await _uiService.ShowConfirmationDialogAsync(
            Dhun.WinUI.Resources.Strings.SettingsPage_ListenBrainz_Disconnect_Title,
            Dhun.WinUI.Resources.Strings.SettingsPage_ListenBrainz_Disconnect_Content,
            Dhun.WinUI.Resources.Strings.SettingsPage_ListenBrainz_Disconnect_Button,
            null);
