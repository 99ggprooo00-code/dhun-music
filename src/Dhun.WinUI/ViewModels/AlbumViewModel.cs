...
public partial class AlbumViewModel : PagedListViewModelBase<Album>
{
    ...
    protected override string FormatTotalItemsText(int count) =>
        count == 1
            ? ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Albums_Count_Singular, count)
            : ResourceFormatter.Format(Dhun.WinUI.Resources.Strings.Albums_Count_Plural, count);
