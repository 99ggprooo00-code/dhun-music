...
public static class ArtistMenuFlyoutHelper
{
        ...
        ILogger logger)
    {
        ...
        var loadingItem = new MenuFlyoutItem { Text = Dhun.WinUI.Resources.Strings.Status_Loading, IsEnabled = false };
        ...
        ILogger logger)
    {
        ...
        catch (Exception ex)
        {
            ...
            dispatcherQueue.TryEnqueue(() =>
            {
                if (subMenu.Items.Contains(loadingItem)) loadingItem.Text = Dhun.WinUI.Resources.Strings.Error_FailedToLoadArtists;
            });
        }
    }
