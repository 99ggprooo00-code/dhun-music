...
{
    private const string StartupTaskId = "DhunAutolaunchStartup";
    ...
    private const string LastFmCredentialResource = "Dhun/LastFm";
    ...
    private const string ListenBrainzTokenResource = "Dhun/ListenBrainz";
