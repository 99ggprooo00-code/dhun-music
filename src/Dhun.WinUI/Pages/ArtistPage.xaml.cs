...
///     This page is responsible for creating and madhunng the lifecycle of its ViewModel.
/// </summary>
public sealed partial class ArtistPage : Page
{
    ...
    private void ExpandSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.ArtistPage_SearchButton_Close_ToolTip);
    ...
    private void CollapseSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.ArtistPage_SearchButton_Search_ToolTip);
