...
public sealed partial class FolderPage : Page
{
    ...
    private async Task ShowDeleteFolderConfirmationDialogAsync(FolderViewModelItem folderItem)
    {
        ...
        {
            Title = Dhun.WinUI.Resources.Strings.FolderPage_DeleteDialog_Title,
            Content = string.Format(Dhun.WinUI.Resources.Strings.FolderPage_DeleteDialog_Format, folderItem.Name),
            PrimaryButtonText = Dhun.WinUI.Resources.Strings.FolderPage_DeleteDialog_PrimaryButton,
            CloseButtonText = Dhun.WinUI.Resources.Strings.FolderPage_DeleteDialog_CloseButton,
