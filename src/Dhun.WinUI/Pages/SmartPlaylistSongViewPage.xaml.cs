...
public sealed partial class SmartPlaylistSongViewPage : Page
{
    ...
    protected override async void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                await ViewModel.InitializeAsync(Dhun.WinUI.Resources.Strings.SmartPlaylistSongViewPage_UnknownPlaylist, null);
            }
        }
        catch (Exception ex)
        {
    ...
    private void ExpandSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.SmartPlaylistSongViewPage_SearchButton_Close_ToolTip);
    ...
    private void CollapseSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.SmartPlaylistSongViewPage_SearchButton_Search_ToolTip);
