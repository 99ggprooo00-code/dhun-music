...
public sealed partial class AlbumViewPage : Page
{
    ...
    private void ExpandSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.AlbumViewPage_SearchButton_Close_ToolTip);
    ...
    private void CollapseSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.AlbumViewPage_SearchButton_Search_ToolTip);
    ...
    private void PopulatePlaylistSubMenu(MenuFlyoutSubItem subMenu)
    {
        ...
        if (availablePlaylists?.Any() != true)
        {
            ...
            var disabledItem = new MenuFlyoutItem { Text = Dhun.WinUI.Resources.Strings.AlbumViewPage_PlaylistMenu_NoPlaylists, IsEnabled = false };
