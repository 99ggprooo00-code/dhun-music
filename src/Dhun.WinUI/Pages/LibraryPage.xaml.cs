...
public sealed partial class LibraryPage : Page
{
    ...
    private void ExpandSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.LibraryPage_SearchButton_Close_ToolTip);
    ...
    private void CollapseSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.LibraryPage_SearchButton_Search_ToolTip);
                ...
                .FirstOrDefault(item => item.Name == "AddToPlaylistSubMenu") is { } addToPlaylistSubMenu)
        {
            ...
            if (ViewModel.AvailablePlaylists.Any())
                ...
                addToPlaylistSubMenu.Items.Add(
                    new MenuFlyoutItem { Text = Dhun.WinUI.Resources.Strings.LibraryPage_PlaylistMenu_NoPlaylists, IsEnabled = false });
        }
