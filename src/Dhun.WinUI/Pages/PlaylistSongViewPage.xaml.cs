...
public sealed partial class PlaylistSongViewPage : Page
{
    ...
    protected override async void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                await ViewModel.InitializeAsync(Dhun.WinUI.Resources.Strings.PlaylistSongViewPage_UnknownPlaylist, null);
            }
        }
        catch (Exception ex)
        {
    ...
    private void ExpandSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.PlaylistSongViewPage_SearchButton_Close_ToolTip);
    ...
    private void CollapseSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.PlaylistSongViewPage_SearchButton_Search_ToolTip);
