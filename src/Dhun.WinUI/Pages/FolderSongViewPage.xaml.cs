...
public sealed partial class FolderSongViewPage : Page
{
    ...
    protected override async void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                await ViewModel.InitializeAsync(Dhun.WinUI.Resources.Strings.FolderSongViewPage_Default_Title, null);
            }
        }
        catch (Exception ex)
        {
    ...
    private void ExpandSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.FolderSongViewPage_SearchButton_Close_ToolTip);
    ...
    private void CollapseSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Dhun.WinUI.Resources.Strings.FolderSongViewPage_SearchButton_Search_ToolTip);
    ...
    private void PopulatePlaylistSubMenu(MenuFlyoutSubItem subMenu)
    {
        ...
        {
            subMenu.Items.Add(new MenuFlyoutItem { Text = Dhun.WinUI.Resources.Strings.FolderSongViewPage_PlaylistMenu_NoPlaylists, IsEnabled = false });
            return;
        }
