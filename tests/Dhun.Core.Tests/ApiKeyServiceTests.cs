...
public class ApiKeyServiceTests : IDisposable
{
    ...
    public ApiKeyServiceTests()
    {
        ...
        _pipelines = TestProviderPipeline.Build(ServiceProviderIds.DhunApi);
    ...
    {
        // Arrange
        _configuration["DhunApiServer:Url"].Returns(string.Empty);
        _configuration["DhunApiServer:ApiKey"].Returns("some-key");
    ...
    {
        _configuration["DhunApiServer:Url"].Returns(url);
        _configuration["DhunApiServer:ApiKey"].Returns("server-api-key");
        _configuration["DhunApiServer:SubscriptionKey"].Returns(subscriptionKey);
    }
